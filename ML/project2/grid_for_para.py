...
class ANN:
    input_num,hidden_num,output_num,learning_rate=100,100,100,0.1
    ...
    def __init__(self,x,y,learning_rate,input_num,hidden_num,output_num):
    ...
    def train_std(self,x1,y1):
        ...
        for i in range(self.output_num):
            g[0,i]= self.hat_y[0,i]*(1-self.hat_y[0,i])*(y1[i]-self.hat_y[0,i])
...
input,hidden,output=len(img[0]),120,len(s)#设置输入层，隐藏层，输出层的神经元个数 125best now
